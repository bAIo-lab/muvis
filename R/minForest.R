#' construct and visualize a minimum forest based on Chow-Liu algorithm indicating the associations among variables in the dataset
#'
#'
#' @description
#' A function to fit a minimum forest to data.
#' The function also visualizes the minimum forest and color the graph based on the communities.
#'
#'
