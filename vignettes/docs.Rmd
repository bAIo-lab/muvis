...
mf.val <- graph_vis(mf$graph, directed = F, community = T, betweenness = T, plot = T, plot.community = T)
mf.val$communities
```

<!-- here should be the VKL --->
## VVKL
...
<!-- plot_assoc(data, vars = c("DIQ010", "PAD590"), levels = 15) -->
<!-- ``` -->
